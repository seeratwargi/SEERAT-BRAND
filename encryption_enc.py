...
note = "# Encrypted By TRICKS BY S33R9T BRAND\n # Github : GitHub.com/rulexseeratbrand\n"
logo =("""   
...
\033[1;36m============================================
\033[1;35m   \033[1;32mCREDIT   : \033[1;32mTRICKER S33R9T BRAND 
\033[1;35m   \033[1;33mOWNER     : \033[1;33mCRIMINAL S33R9T 
\033[1;36m   \033[1;35mGITHUB       :  \033[1;35mAKSARDARNI WARGI
\033[1;32m   \033[1;36mTOOL  :  \033[1;36mENCYPTED TOOL
\033[1;32m   \033[1;35mRULEX TEAM        :  \033[1;35mROYAL PUNJAB RULEX 
\033[1;34m   \033[1;32mTOOL VIRSION :  \033[1;32m0.2
\033[1;36m============================================\n""")
...
def MainMenu():
    try:
        ...
        os.system('xdg-open https://github.com/ayushking420');time.sleep(5)
        print(logo)
        menu()
        try:
        ...
        if option > 0 and option <= 17:
            if option == 17:
                sys.exit("\n Thanks For Using Satyaa's Tool")
            os.system('clear') # os.system('cls')
            print(logo)
        else:
            sys.exit('\n Invalid Option !')
